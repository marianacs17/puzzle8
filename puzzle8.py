...
# A* algorithm with puzzle8

from copy import deepcopy
from colorama import Fore, Back, Style

DIRECTIONS = {"U": [-1, 0], "D": [1, 0], "L": [0, -1], "R": [0, 1]}     # this are the instructions to move the void
END = [[1, 2, 3],       # this is the expected result
       [8, 0, 4],
       [7, 6, 5]]

# unicode for drawing the box
left_down_angle = '\u2514'
right_down_angle = '\u2518'
right_up_angle = '\u2510'
left_up_angle = '\u250C'
...
# this function gets the actual position of the element reviewing and returns the row
...
# gets the total cost that is moving from the root or first node to the goal node
